...
synth.noise.distrib         =             'chisq';                         %Noise: 'normal', 'chisq', 't' or 'exp';   
...
synth.features.sparsity     =                   5;                         %|V|, the number of inactive variables
...
param.inner.kerOpt          =            'Gauss';                          %Modal Kernel 
...
param.outer.itermax         =               3000;                          %The number of outer iterations
param.outer.nGroups         =            param.L;                          %The number of groups
